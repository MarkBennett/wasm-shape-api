...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'shape.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'shape.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'shape.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "shape.js.mem" : null;
...
var _int_sqrt = Module["_int_sqrt"] = function() { return Module["asm"]["_int_sqrt"].apply(null, arguments) };
